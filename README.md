...
* **Centralisation des travaux :** J'utilise ce compte pour héberger mes différents projets, qu'ils soient réalisés dans un cadre académique ou personnel.
* **Suivi technique :** Vous trouverez ici mes compétences sur différents langages comme le Java, le Python, le SQL, du Bash etc.
...
| **[JS Wagee](https://github.com/baptiste-wagee/Site-JS-Wagee)** | Site vitrine réalisé pour mettre en avant des productions musicaux. | HTML, CSS |
...
![Looping](https://img.shields.io/badge/Looping-EEEEEE?style=flat-square&logo=data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAACXBIWXMAAAsTAAALEwEAmpwYAAAA&logoColor=black) 
